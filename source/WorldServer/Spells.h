...
public:
	...
	int32 GetSpellID();
	void SetPacketInformation(PacketStruct* packet, Client* client = nullptr, bool display_tier = false);
	void SetSpellPacketInformation(PacketStruct* packet, Client* client = nullptr, bool display_tier = false, bool pvp = false);
	int8 GetSpellTier();
...
public:
	...
	void Reload();
	EQ2Packet* GetSpellPacket(int32 id, int8 tier, Client* client = nullptr, bool display = false, int8 packet_type = 0);
	EQ2Packet* GetSpecialSpellPacket(int32 id, int8 tier, Client* client = nullptr, bool display = false, int8 packet_type = 0);
